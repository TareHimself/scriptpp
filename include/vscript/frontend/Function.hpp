...
namespace vs::frontend
{
    ...
    public:
        RuntimeFunction(const std::shared_ptr<ScopeLike>& scope,const std::shared_ptr<backend::FunctionNode>& function);
    ...
    std::shared_ptr<RuntimeFunction> makeRuntimeFunction(const std::shared_ptr<ScopeLike>& scope,const std::shared_ptr<backend::FunctionNode>& function,bool addToScope = true);
